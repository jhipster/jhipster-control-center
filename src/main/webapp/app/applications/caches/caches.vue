            ...
            <div v-if="cachesMetrics && caches">
                ...
                <table class="table table-bordered table-striped" aria-describedby="statistics">
                    <thead class="thead-light">
                        ...
                        <th scope="col" class="text-right" v-on:click="[changeOrderMetrics('missPercent'), clearPaginationMetrics()]">Cache Miss %</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div v-show="caches && caches.length > 0">
                    <div class="row justify-content-center">
                        <b-pagination size="md" :total-rows="cachesFiltered.length" v-model="page" :per-page="itemsPerPage" :change="loadPage(page)"></b-pagination>
                    </div>
                </div>
            </div>
        </div>
